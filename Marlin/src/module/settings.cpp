...
void MarlinSettings::reset() {
  ...
  //
    ...
    #endif
    // mmm constexpr float _filament_heat_capacity_permm[] = FILAMENT_HEAT_CAPACITY_PERMM;
    ...
    #endif
    // mmm static_assert(COUNT(_filament_heat_capacity_permm) == HOTENDS, "FILAMENT_HEAT_CAPACITY_PERMM must have HOTENDS items.");
    ...
    HOTEND_LOOP() {
      ...
      #endif
      // mmm thermalManager.temp_hotend[e].constants.filament_heat_capacity_permm = _filament_heat_capacity_permm[e];
    }
  #endif
