...
#define STRING_CONFIG_H_AUTHOR "Matthew Coon" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Ender 3 V2
  #define DEFAULT_bedKp 117.34 // mmm
  #define DEFAULT_bedKi  18.53 // mmm
  #define DEFAULT_bedKd 495.42 // mmm
...
#define USE_PROBE_FOR_Z_HOMING  // mmm
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -10, 0 }   // mmm
...
#define Z_MIN_PROBE_REPEATABILITY_TEST // mmm
...
#define HOME_AFTER_DEACTIVATE   // mmm Require rehoming after steppers are deactivated. Also enable NO_MOTION_BEFORE_HOMING for extra safety.
 ...
 */
#define FILAMENT_RUNOUT_SENSOR  // mmm
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.
#if ENABLED(MATT_BTT)
  #define FIL_RUNOUT_STATE     LOW       // mmm Pin state indicating that filament is NOT present.
#else
  #define FIL_RUNOUT_STATE     HIGH       // mmm Pin state indicating that filament is NOT present.
#endif
  ...
  #define FILAMENT_RUNOUT_DISTANCE_MM 7 // mmm used as filter
...
#define AUTO_BED_LEVELING_UBL // mmm
...
//#define DEBUG_LEVELING_FEATURE
  ...
  #define GRID_MAX_POINTS_X 5 // mmm
...
#define LEVEL_BED_CORNERS // mmm
  ...
  #define LEVEL_CORNERS_USE_PROBE // mmm
...
#define HOMING_FEEDRATE_MM_M { (50*60), (50*60), (8*60) } // mmm XY default, Z fast
