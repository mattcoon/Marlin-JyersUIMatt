...
#elif MB(CREALITY_V4)
  #include "stm32f1/pins_CREALITY_V4.h"         // STM32F1                                env:STM32F103RE_creality_matt env:STM32F103RE_creality_dad env:STM32F103RE_creality_427MPC env:STM32F103RE_creality_422MPC
