...
outFile = os.path.splitext(env_slicer_pp_output_name)[0]+"_thumb"+os.path.splitext(env_slicer_pp_output_name)[1]
...
lines = lines.replace("; generated by PrusaSlicer 2.4.0", "; generated by PrusaSlicer 2.3.3/2.4.0")
