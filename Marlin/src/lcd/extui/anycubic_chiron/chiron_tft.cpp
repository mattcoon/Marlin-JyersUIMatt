...
void ChironTFT::Startup() {
  ...
  // suprr -> // Filament runout is handled by Marlin settings in Configuration.h
  // suprr -> // opt_set    FIL_RUNOUT_STATE HIGH  // Pin state indicating that filament is NOT present.
  // suprr -> // opt_enable FIL_RUNOUT_PULLUP
  TFTSer.begin(115200);
