...
#elif MB(CREALITY_V4)
  #include "stm32f1/pins_CREALITY_V4.h"         // STM32F1                                env:STM32F103RE_creality_427PID env:STM32F103RE_creality_422PID env:STM32F103RE_creality_427MPC env:STM32F103RE_creality_422MPC
